...
export WORLD_PACKAGES=(
  ...
  #www-servers/nginx::alopatindev-overlay
)
...
function post_emerge_packages() {
  ...
  [ -e /etc/containers/registries.conf ] && echo 'unqualified-search-registries = ["docker.io"]' >> /etc/containers/registries.conf
